...
returned tracks included an artwork reference. Its physical-device retest is
pending.**
...
Version 0.1.29 retains the adapter validated against a real Sonos household
