...
| End-user download | `dist/Miyonos-App-0.1.28.zip` — a single `Miyonos` folder to put in `App` |
...
| Last verified device state | Version 0.1.23 is installed. Version 0.1.28 was validated against the live household: a Spotify Favorite Playlist opened Now Playing immediately, retained its playlist name, and replaced the active queue with 100 playlist tracks. Its physical retest is pending. |
| Current 0.1.28 package ARM binary SHA-256 | `7be070455bd743381015d0c3e2710a86b960e1abf0ae7ebcfad8406acf2b064a` |
| Automated verification | 233 core checks, 131 simulator-input checks, 73 simulator-fixture checks, simulator screenshot/storage checks, and package integrity checks passed |
...
1. Extract `dist/Miyonos-App-0.1.28.zip`.
